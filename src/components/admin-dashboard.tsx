...
type Review = { id: number; author_name: string; content: string; service_name: string; rating: number; sort_order: number; active: boolean; status: "pending" | "approved" | "rejected"; source: "public" | "admin"; consent_at: string | null; created_at: string };
